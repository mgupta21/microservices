...
**Note** Be sure to use the Vagrantfile in this lesson, as the older ones don't run Prometheus.
...
- Prometheus on **services** Vagrant Box: ```http://192.168.33.10:9090/status```
- Promdash on **services** Vagrant Box: ```http://192.168.33.10:3000```
