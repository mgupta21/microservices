...
- Local News Service running on localhost in IDE: ```http://localhost:8080/news/{city}```. Example: ```http://localhost:8080/news/chicago``` returns a fake news article for Chicago IL
- Load News Articles into Elasticsearch for Local News Service: ```http://localnews:8080/load```
